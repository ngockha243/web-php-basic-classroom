        ...
        <div class="col-md-6 col-lg-5">
            ...
            <?php
                if(!empty($error)){
                    ...
                    <form novalidate method="post" action="" class=" new-join-class">
                        ...
                        <div class="form-group text-center">
                            ...
                            if(!empty($success)){
                                ...
                                echo "<button class='btn  px-5 login-form'><a href='login.php'>Login</a></button>";
                            }

                            ?>
                            <button class="btn  px-5 ">Change password</button>
                        </div>
                    </form>
