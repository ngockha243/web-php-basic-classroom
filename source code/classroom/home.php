        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
            ...
            <form method="POST" action="">
                ...
                <div class="card">
                    ...
                    <button class="lop-lon" name="lop3">
                        ...
                        <div class="card-body">
                            ...
                            <input readonly type="text" name="class-name" class="form-control" id="class-name" value="<?=$user[0]?>">

                            <label for="subject">Môn học:</label>
                            <input readonly type="text" name="subject" class="form-control" id="subject" value="<?=$user[1]?>">

                            <label for="room">Phòng:</label>
                            <input readonly type="text" name="room" class="form-control" id="room" value="<?=$user[2]?>">
                            <input type="hidden" name="lop5" class="form-control" id="room" value="<?=$user[4]?>">
