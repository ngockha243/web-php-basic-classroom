...
$result = search_class_by_student($key, $_SESSION['user']);
                ...
                <form method="POST" action="#">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input readonly type="text" name="class-name" class="form-control" value="<?=$user[0]?>">
                            <label for="subject">Môn học:</label>
                            <input readonly type="text" name="subject" class="form-control" value="<?=$user[1]?>">
                            <label for="room">Phòng:</label>
                            <input readonly type="text" name="room" class="form-control" value="<?=$user[2]?>">
                            <!--                            <div class = "item-header"><h5>--><?//=$user[0]?><!--</h5></div>-->
                            <!--                            <div class = "item-cost"><h6>--><?//=$user[1]?><!--</h6></div>-->
                            <!--                            <div class = "item-cost"><h6>--><?//=$user[4]?><!--</h6></div>-->
                        </div>
                        <div class="card-footer">
                            <input type="hidden" name="lop5" value="<?=$user[4]?>">
